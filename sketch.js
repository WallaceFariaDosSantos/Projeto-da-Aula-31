...
function draw() {
  ...
  for (var stone of stones) {
    ...
    if (distance <= 50) {
      ...
      fixButton = createButton("");
      fixButton.position(200, height / 2 - 50);
      fixButton.class("fixbutton");
      fixButton.mousePressed(fixButtonPress);
    }
  }
